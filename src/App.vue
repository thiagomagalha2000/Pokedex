    ...
    <v-dialog v-model="show_dialog" width="800">
      <v-card v-if="selected_pokemon">
        <v-container>
          ...
          <h2 class="text-center">Movimentos</h2>
          <h3 class="text-center" v-if="filter_moves(selected_pokemon).length==0">Esse pokemon não possue nenhum move ainda</h3>
          ...
          <h2 class="text-center">Variações</h2>
          <v-row class="d-flex align-center">
            <v-col cols="4">
              <img
